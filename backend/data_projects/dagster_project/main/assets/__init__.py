...
@asset(key_prefix=["dbt_project"], group_name="staging")
...
dbt_assets = load_assets_from_dbt_project(
    project_dir=DBT_PROJECT_PATH, profiles_dir=DBT_PROFILES, key_prefix=["dbt_project10937
                                                                         


# @asset(ins={"customers": AssetIn(key_prefix=["dbt_project"])}, group_name="staging")
