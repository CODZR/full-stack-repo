...
export class ItemsService {
	 ...
	 * @throws ApiError
	 */
	public static createItem({ requestBody }: { requestBody: ItemCreate }): CancelablePromise<ItemOut> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/items/',
			body: requestBody,
	 ...
	 * @throws ApiError
	 */
	public static readItem({ id }: { id: number }): CancelablePromise<ItemOut> {
		return __request(OpenAPI, {
			method: 'GET',
			url: '/api/v1/items/{id}',
			path: {
	 ...
	 * @throws ApiError
	 */
	public static deleteItem({ id }: { id: number }): CancelablePromise<Message> {
		return __request(OpenAPI, {
			method: 'DELETE',
			url: '/api/v1/items/{id}',
			path: {
