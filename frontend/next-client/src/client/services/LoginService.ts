...
export class LoginService {
	 ...
	 * @throws ApiError
	 */
	public static recoverPassword({ email }: { email: string }): CancelablePromise<Message> {
		return __request(OpenAPI, {
			method: 'POST',
	 ...
	 * @throws ApiError
	 */
	public static resetPassword({ requestBody }: { requestBody: NewPassword }): CancelablePromise<Message> {
		return __request(OpenAPI, {
			method: 'POST',
