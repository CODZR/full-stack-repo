const ViewOffIcon = () => {
	return (
		<svg aria-label="Show password" className="chakra-icon css-onkibi" focusable="false" viewBox="0 0 24 24">
			<svg className="chakra-icon css-13lpg1h" focusable="false" viewBox="0 0 24 24">
				<g fill="currentColor">
